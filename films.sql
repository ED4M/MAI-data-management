...
CREATE TABLE IF NOT EXISTS  HW1.PERSONS2CONTENT(
 ...
 INSERT INTO HW1.FILMS (TITLE, ID, COUNTRY, BOX_OFFICE, RELEASE_DATE) VALUES
...
INSERT INTO HW1.PERSONS ( ID,  FIO)  VALUES 
  ( 1, 'Нолан Кристофер'), 
  ( 2, 'Роберт Эггерс'), 
  ( 3, 'Ханс Циммер'), 
  ( 4, 'Вуди Харрельсон'), 
...
INSERT INTO HW1.PERSONS2CONTENT (  PERSON_ID, FILM_ID, PERSON_TYPE) VALUES 
(1, 1, 'Режиссёр'), 
(2, 2, 'Режиссёр'), 
(3, 3, 'Композитор'), 
(4, 4, 'Актёр'), 
